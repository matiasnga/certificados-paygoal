...
def contar_archivos_pdf(archivo):
    ...
    return cantidad_archivos_pdf, tamano_zip, tamano_descomprimido


with zipfile.ZipFile(archivo_zip, 'r') as zip_file:
    cantidad_archivos, tamano_zip, tamano_descomprimido = contar_archivos_pdf(zip_file)
